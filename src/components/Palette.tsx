...
const useStyles = makeStyles({
  palette: {
    ...
    ...shorthands.borderRight('1px', 'solid', 'rgba(0, 0, 0, 0.08)'),
    backdropFilter: 'blur(60px) saturate(1.8)',
    WebkitBackdropFilter: 'blur(60px) saturate(1.8)',
    position: 'relative',
    zIndex: 10,
    boxShadow: '0 0 0 0.5px rgba(255, 255, 255, 0.9), 0 8px 32px rgba(0, 0, 0, 0.12), 0 2px 8px rgba(0, 0, 0, 0.08)',
    overflowY: 'auto',
    scrollbarWidth: 'thin',
  ...
  agentCard: {
    ...
    boxShadow: '0 0 0 0.5px rgba(255, 255, 255, 0.6), 0 2px 4px rgba(0, 0, 0, 0.06), 0 8px 16px rgba(0, 0, 0, 0.04)',
    '&:hover': {
      backgroundColor: 'rgba(255, 255, 255, 0.6)',
      ...shorthands.border('1px', 'solid', 'rgba(255, 255, 255, 0.5)'),
      boxShadow: '0 0 0 0.5px rgba(255, 255, 255, 0.8), 0 4px 12px rgba(0, 0, 0, 0.1), 0 16px 32px rgba(0, 0, 0, 0.08)',
